...
library(knitr)
setwd("C:\\Users\\Kirtan\\Documents\\coursera\\machine learning")
training <- read.csv ("C:\\Users\\Kirtan\\Documents\\coursera\\machine learning\\pml-training.csv")
testing <- read.csv("C:\\Users\\Kirtan\\Documents\\coursera\\machine learning\\pml-testing.csv")
dim(training)
head(training)
